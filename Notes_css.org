...
Document Object Model (DOM) : https://web-dev.imgix.net/image/C47gYyWYVMMhDmtYSLOWazuyePF2/cSL20piziX7XLekCPCuD.png

[[file:./css_images/dom-css.png]]
...
.post a {  /*All anchor tag in class post */
   color: #f1faee;
}
...
Keyword added to a selector that lets you style a particular part selected element(s)
...
*** Order and Conflit with selector: Specificity
...
ID: high priority
class: hig priority
element and pseudo: normal priority


Cal what is specificity : https://specificity.keegan.st/
** CSS Inheritance
#+begin_src 
body {
  color: purple; /* all h1,h2, p, div...all inheritance  */
}
#+end_src
...
text-decoration: underline solid wavy;
text-decoration: none

line-height: {normal,2.5,3em, 150%, 32px}
letter-spacing: 2px,

font-size: 2px, 3em, ....etc
font-family: Georgia, serif;, sans-serif, serif,
...
[[file:./css_images/th-625111471.jpeg]]
...
MDN LINK :  https://developer.mozilla.org/en-US/docs/Web/CSS/border-color
#+begin_src css
.bx {
    border-width: 2px;
    border-style: solid;
...
#+STARTUP: inlineimages
[[file:./css_images/sibling_collapsing.png]]
...
** TODO Box Sizing:
Pratice html: file:./html-pratice/box-sizing.html
...
demo : file: file:./html-pratice/display.html

There are three Display Types:
1. Inline: Width & Height are ignored, Margin & Padding push elements away horizontally but not vertically.
2. Block:Block element break flow of a document. Width,Height, Margin, & Padding are respected. 
3. Inline-Block: Behaved like an inline element expect Width,Height, Margin, Padding are  configured.
4. none: Hide the the block
...
#+begin_src csss
div {
   backgroud-color: #e589b;
   width: 50%;
   height: 50%; /* parent width and height */
}
...
With font-size, 1em equals to the font-size of the parent, 2em's is twice the font-size of the parent,  etc.
...
#+end_src
above code fails for nested list as nest grows the font size increase or decrease respectively

So for that we use =rem=
*** Rem
...
- *relative* :The top/bottom/left/right/z-index will now work
	     ...
	     - It relative to the parent block  
...
[[file:./css_images/vd9dc7wfk9471.png]]
source: https://www.reddit.com/r/webdev/comments/nvzhi0/flexbox_css_cheat_sheet/


Before we look into CSS-Flexbox , we will look into float and clear properties, display
Practice: file:///home/karthik/mynotes/web-dev/html-pratice/flexbox.html
...
#+STARTUP: inlineimages
[[file:./css_images/bw4hK0MYxFXbw7ylW2fR5Q.png]]
...
#+begin_src css
:root {
  --highlite-background: #f9f8f7;
  --highlite-hover:  #dbd9d7;
}
header {
  background-color: var(--highlite-background); /*#f7d393;*/
  /* black; */
  color: black;
}
